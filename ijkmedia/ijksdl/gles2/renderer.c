...
static IJK_GLES_Matrix modelViewProj;
...
GLboolean IJK_GLES2_Renderer_use_simple(IJK_GLES2_Renderer *renderer)
{
    if (!renderer)
        return GL_FALSE;
...
void getRenderFrameSize(IJK_GLES2_Renderer *render, int* width, int* height){
