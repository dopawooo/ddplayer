...
- (void)awakeFromNib
{
    ...
    _lightnessSlider.minimumValue = 0;
    _lightnessSlider.maximumValue = 100;
    _lightnessSlider.value = [[UIScreen mainScreen] brightness] * 100;
    _lightnessSlider.transform =  CGAffineTransformMakeRotation( M_PI * 1.5 );
}
...
- (IBAction)lightnessChange:(id)sender {
    [[UIScreen mainScreen] setBrightness: _lightnessSlider.value / _lightnessSlider.maximumValue];
}
